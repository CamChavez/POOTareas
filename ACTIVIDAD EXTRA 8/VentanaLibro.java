...
public class VentanaLibro extends JFrame {
    ...
    private JButton btnCaargar;
    private JTable tblLibro;
    private JScrollPane scroll;
    private GridLayout layout;
    private JPanel panel1; //formulario para captirar libros
    ...
    public VentanaLibro(String title) throws HeadlessException {
        ...
        panel1.setBackground(new Color(135, 222, 192));
        lblId = new JLabel("Id: ");
        ...
        panel2.setBackground(new Color(135, 192, 222));
        btnCaargar = new JButton("Cargar");
        panel2.add(btnCaargar);
        tblLibro = new JTable();
        ...
        panel3.setBackground(new Color(197, 135, 222));


        //Panel 4
        panel4 = new JPanel(new FlowLayout());
        panel4.setBackground(new Color(222, 135, 187));
    ...
    public JButton getBtnCaargar() {
        return btnCaargar;
    }

    public void setBtnCaargar(JButton btnCaargar) {
        this.btnCaargar = btnCaargar;
    }
}
